...
import { ArrowLeft, Bot, Check, ChevronDown, FileAudio, FileUp, GraduationCap, LayoutDashboard, MoreHorizontal, Pencil, Plus, Search, Send, Settings, Sparkles, Trash2, Users, X, Crown } from "lucide-react";
import { sentences } from "@/data/sentences";
import MembershipAdmin from "@/components/admin/MembershipAdmin";

const sections = ["Tổng quan", "Khóa học", "Danh mục", "Bài học", "Câu luyện", "Từ vựng", "Audio", "Người dùng", "Thành viên", "Xếp hạng"];
